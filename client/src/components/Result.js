    ...
    <div className="flex justify-center mt-8 mx-2">
      <div className="md:flex md:w-[800px] py-8 bg-white px-4 rounded-lg">
        ...
        <div className="md:w-1/2 ml-2">
          ...
          <p className="text-xl font-semibold text-center">Choose Formate</p>
          <div className="flex justify-center  md:justify-start">
            <div className="pt-4 flex flex-col gap-4 md:block">
              <select
                onChange={(e) => setResu(e.target.value)}
                className="px-3 mx-1 py-2 outline-none md:mr-8 border-green-500 border rounded-md"
              >
              ...
              <button
                ...
                className="px-4  bg-orange-400 hover:bg-orange-600 rounded-lg text-white font-serif text-lg py-1 md:mr-5"
                type=""
              >
                Download
              </button>
